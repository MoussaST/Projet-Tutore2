...
public class Objets {
	...
	public Objets() {
		...
		this.tabObjet[1][2]="1";
		this.tabObjet[2][2]="S";
		this.tabObjet[0][3]="potion de soins";
		this.tabObjet[1][3]="1";
		this.tabObjet[2][3]="S";
		this.taille=4;
	}
	...
	public void ajouterObjets(Carte t){
		boolean verif =true;
		Scanner n = new Scanner(System.in);
		this.taille=this.taille+1;
		while(verif){
			System.out.println("Saisissez la ligne et la colonne de la case de l'objet que vous voulez ramasser");
			...
			if (t.getTab(ligne, colonne).equals("a")){
				...
				System.out.println("Erreur: la case saisie ne contient pas un objet");
			}
		}
	}
